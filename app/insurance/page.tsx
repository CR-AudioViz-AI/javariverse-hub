    ...
    <div className="min-h-screen bg-gradient-to-b from-cyan-500 to-white">
      ...
      <section className="bg-gradient-to-r from-cyan-500 to-cyan-500 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-cyan-500 mb-8">Compare insurance quotes and find the best coverage</p>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <Link href="/" className="inline-block mt-6 px-6 py-3 bg-cyan-500 text-white rounded-lg hover:bg-cyan-500">
            Return Home
          </Link>
        </div>
      </section>
