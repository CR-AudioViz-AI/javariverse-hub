'use client'
// Javari Travel - CR AudioViz AI Module | Generated: 2026-01-02T02:09:46.625Z
import Link from 'next/link'

export default function JavariTravelPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-gray-900 text-white">
      <header className="border-b border-white/10 p-4">
        <Link href="/" className="flex items-center gap-2">
          <span className="text-2xl">✈️</span>
          <span className="text-xl font-bold">Javari Travel</span>
        </Link>
      </header>
      <main className="max-w-4xl mx-auto p-8 text-center">
        <span className="text-6xl mb-6 block">✈️</span>
        <h1 className="text-4xl font-bold mb-4">Javari Travel</h1>
        <p className="text-xl text-gray-300 mb-8">Travel planning & booking</p>
